  ...
  <div class="card p-3">
    <div class="card-body">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="action-links">
                <%-- Placeholder links: keep them as # for now as original code did. Replace with real servlets when implemented --%>
                <a href="#" class="btn btn-sm btn-outline-primary" role="button" aria-label="Retry transaction <%= id %>">Retry</a>
                <a href="#" class="btn btn-sm btn-outline-danger" role="button" aria-label="Refund transaction <%= id %>">Refund</a>
              </td>
            </tr>
            <%
              } // end while
      ...
      <div class="d-flex justify-content-between align-items-center mt-3">
        ...
        <div class="muted" style="font-size:13px;">Actions (Retry / Refund) are placeholders here</div>
      </div>
    </div>
  </div>
</div>
